...
// Validation Schema.
const PendingValidation = Yup.object().shape({
  title: Yup.string().required("Title is requrired"),
  content: Yup.string().required("Text is requrired"),
});

const PendingVerifyModal = ({ subTitle, user_id, statusKyc, from, getKYC }) => {
        ...
        <Dialog open={open} onClose={handleClose}>
          ...
          <DialogContent>
            <Formik
              ...
              initialForms={state}
              validationSchema={PendingValidation}
